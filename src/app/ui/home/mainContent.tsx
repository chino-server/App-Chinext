  ...
  return (
    <div className="flex justify-start items-center min-h-screen ">
      <div className=" p-5 space-y-6 max-w-lg ">
        <h1 className="text-4xl font-bold bg-gradient-to-br from-orange-500 to-yellow-200 bg-clip-text text-transparent ">
          {title}
        </h1>
        ...
        <div className="space-x-4 ml-5">
          ...
          <button
            ...
            type="button"
            className="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-full text-sm px-3 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2"
          >
            <svg
              aria-hidden="true"
